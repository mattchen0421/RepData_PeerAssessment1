...
```
the mean of the total number of steps taken per day is `step_mean`
the mean of the total number of steps taken per day is `step_median`
...
```
the interval contains the maximum number of steps is `step_max`
...
```
new mean of the total number of steps taken per day is `step_mean1`
new mean of the total number of steps taken per day is `step_median1`
